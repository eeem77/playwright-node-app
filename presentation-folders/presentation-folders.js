...
const web = async () => {
    ...
    await page.goto('https://www.uprinting.com/silk-presentation-folders.html', { timeout: 300000 })
    ...
    await changeOneOptions(page, 4, 1)
