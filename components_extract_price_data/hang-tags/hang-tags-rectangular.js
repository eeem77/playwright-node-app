...
const web = async () => {
    ...
    await page.goto('https://www.uprinting.com/rectangular-hang-tag-printing.html', { timeout: 300000 })

    await page.waitForTimeout(15000)
    
    // await changeOneOptions(page, 1, 1)
    await changeOneOptions(page, 5, 0)
